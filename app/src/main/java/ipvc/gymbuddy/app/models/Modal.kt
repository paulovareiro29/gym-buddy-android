...
open class Modal(private val layoutId: Int) : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(title: String, contentFragmentClassName: String): Modal {
            val fragment = Modal(R.layout.modal)
            val args = Bundle()
